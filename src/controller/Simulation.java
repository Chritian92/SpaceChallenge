...
public class Simulation {
    ...
    /**
     * Metod by compare the total cost.
     * @param totalCostU1 of the rocket 1.
     * @param totalCostU2 of the rocket 2.
     * @return String with the better option.
     */
    public String compareCost(double totalCostU1, double totalCostU2){
        return  totalCostU1 < totalCostU2 ? "The U1 is the best option" : "The U2 is the best option";
    }
}
